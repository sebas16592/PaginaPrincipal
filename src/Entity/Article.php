...
class Article
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Usuario::class, inversedBy="articles")
    ...
    public function setAuthor(?Usuario $author): self
    {
        $this->author = $author;
    ...
    public function setLocation(?string $location): self
    {
        ...
        if (!$this->location || $this->localtion === 'interstellar_space') {
